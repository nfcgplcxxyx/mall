package com.jcfx.mall.product.exception;
 ...
 */
@Slf4j
@RestControllerAdvice(basePackages = "com.jcfx.mall.product.controller")
public class MallExceptionControllerAdvice {

    // 所有MethodArgumentNotValidException抛出的地方都会被这个方法处理
